...
export const Payment = () => {
  ...
  return (
    <PaymentContainer>
      <div>
        <p className="payment-title">Myntra</p>
        ...
        <section className="payment-section-2">
          <p className="section2-title">Pay Instantly using QR code</p>
          <p className="section2-dis">Scan QR Code using paytm app</p>
          {/* <img className="paytm-logo" src={paytmLogo} alt={paytmLogo} /> */}
          <img
            className="qr-code"
        ...
        <section className="payment-section-3">
          ...
          <p className="dis1">Pay easily using your saved payment method</p>
          <p className="moblile-dis">Mobile number registered with paytm</p>
          {flag ? (
            <>
          ...
          />
          <div className="secure">100% Secure Payments Powered by Paytm</div>
        </section>
      </div>
    </PaymentContainer>
  );
