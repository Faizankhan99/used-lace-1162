...
import { Input,IconButton,Stack,Image,Box ,InputLeftElement,InputGroup} from '@chakra-ui/react'
  ...
  return (
    <div>
      ...
      {/* <Stack direction={['column']} > */}
       ...
       <Link to="/" className={styles.link} ><Image src='https://www.freepnglogos.com/uploads/logo-myntra-png/myntra-logo-m-png-3.png' h="100%" w="200%" alt='Dan Abramov' /></Link>
       
          <div className={styles.nav5}>
         <ul>
          <li><NavLink to="mens">MENS</NavLink>
                <div clasName={styles.nav5}>
                    <ul>
           ...
           <ul>
            ...
            <ul>
          <li><NavLink to="womens">WOMENS</NavLink>
                <div>
                    <ul>
      ...
      <ul>
          ...
          <li><a href="">HOME & LIVING</a>
              ...
              <ul>
                    ...
                    <ul>
                        <li><a href="">BDungarees & Jumpsuits</a> </li>
                        <li><a href="">Clothing Sets</a> </li>
                        <li><a href="">Tights & Leggings</a> </li>
                        <li><a href="">Sports Shoes</a> </li>
                        <li><a href="">Sandals</a> </li>
